...
-- For menu_photo
CREATE POLICY "Allow all operations on menu_photo" ON menu_photo FOR ALL USING (true);

-- For menu_list
CREATE POLICY "Allow all operations on menu_list" ON menu_list FOR ALL USING (true);
